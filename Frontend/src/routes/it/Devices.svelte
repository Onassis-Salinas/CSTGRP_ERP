...
<div class="flex justify-between mb-6">
    <div>
        <Button size="sm" on:click={createDevice}><PlusOutline class="mr-2" />Añadir dispositivo</Button>
    </div>
</div>
            ...
            <TableBodyRow>
                <TableBodyCell tdClass="px-0 sticky left-0 bg-inherit">
                    ...
                    <Dropdown containerClass="z-[999] flex gap-2" placement="right" class="p-2 flex gap-2">
                        <Button size="xs" on:click={() => editDevice(i)}><EditOutline />Editar</Button>
                        <Button size="xs" on:click={() => deleteDevice(i)} color="red"><TrashBinOutline />Eliminar</Button>
                    </Dropdown>
                </TableBodyCell>
