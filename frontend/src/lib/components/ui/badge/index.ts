...
export const badgeVariants = tv({
	base: 'focus:ring-ring outline outline-1 inline-flex select-none items-center rounded-sm px-1.5 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2',
	variants: {
		variant: {
